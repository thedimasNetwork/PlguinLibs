...
import stellar.logger.DiscordLogger;
...
public enum Rank {
    ...
    // TODO: colors for special ranks and better owner icon
...
//    developer(Color.orange, "\uE869", true),
    ...
    private static final ObjectMap<String, Rank> ranks = new ObjectMap<>();
    private static final ObjectMap<String, Rank> specialRanks = new ObjectMap<>();
